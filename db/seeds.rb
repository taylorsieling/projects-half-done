...
Yarn.create({brand: "KnitPicks",name: "Wool of the Andes", weight: 4, color: "Red", quantity: 1, project_id: hat.id, user_id: hh.id})
Yarn.create({brand: "Lion Brand", name: "24/7 Cotton", weight: 3, color: "Cafe Au Lait", quantity: 3, project_id: bag.id, user_id: hh.id})
Yarn.create({brand: "Lion Brand", name: "Wool-Ease", weight: 4, color: "Oatmeal", quantity: 3, project_id: scarf.id, user_id: sa.id})
Yarn.create({brand: "Lion Brand", name: "Fisherman's Wool", weight: 4, color: "Birch Tweed", quantity: 5, project_id: 4, user_id: ts.id})
Yarn.create({brand: "Wool and the Gang", name: "Crazy Sexy Wool", weight: 6, color: "Bronzed Olive", quantity: 8, project_id: blanket.id})
Yarn.create({brand: "Lion Brand", name: "Vanna's Choice", weight: 4, color: "Terracotta", quantity: 1, project_id: ornament.id, user_id: oi.id})
Yarn.create({brand: "Lion Brand", name: "Vanna's Choice", weight: 4, color: "Mustard", quantity: 1, project_id: ornament.id, user_id: oi.id})
